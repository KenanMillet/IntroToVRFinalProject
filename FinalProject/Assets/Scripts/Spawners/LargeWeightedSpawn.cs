...
public class LargeWeightedSpawn : ProceduralSpawnScript
{
    ...
    {
        //assigns enemyIndex with a preference for large enemy types - wave will be weighted
        //to have a percentage of large enemies based on parameters6 passed to this method
        ...
        else enemyIndex = 2; //default case for rounding errors
