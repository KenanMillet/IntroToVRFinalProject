//This script is only here for Kenrick to reference when doing spawn stuff
//This script is not to be used, however. Use a ProceduralSpawnScript instead (see ExampleProceduralSpawnScript for more info)
