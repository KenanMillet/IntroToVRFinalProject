...
public class MediumWeightedSpawn : ProceduralSpawnScript
{
    ...
    {
        //assigns enemyIndex with a preference for medium enemy types - wave will be weighted
        //to have a percentage of medium enemies based on parameters6 passed to this method
        ...
        else enemyIndex = 1; //default case for rounding errors
